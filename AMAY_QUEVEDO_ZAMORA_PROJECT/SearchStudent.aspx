...
<body class="antialiased relative">
    ...
    <form id="form1" runat="server">
        <!-- Hidden field to store the last search term using ViewState -->
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-wrap items-center justify-between py-3 md:py-4 gap-3">
                        ...
                        <div class="flex items-center gap-3 md:gap-4">
                            <%-- Home button now points to Teacher.aspx (the new home page) --%>
    ...
    <script>
        ...
        function performSearch() {
            ...
            // Store the search term in ViewState using the hidden field
            if (lastSearchHidden) {
        ...
        function init() {
            ...
            // Simple logic: Check if there's a stored keyword from ViewState
            try {
                if (lastSearchHidden && lastSearchHidden.value) {
                    // Stored keyword found - restore it and perform search
                    searchInput.value = lastSearchHidden.value;
                    performSearch();
                } else {
                    // No keyword stored - show all announcements (default)
                    renderResults();
                }
            } catch (e) {
