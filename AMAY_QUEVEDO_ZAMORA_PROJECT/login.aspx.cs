...
namespace AMAY_QUEVEDO_ZAMORA_PROJECT
{
    ...
    {
        private readonly string connectionString = @"Data Source=DESKTOP-C0LQQT8\SQLEXPRESS;Initial Catalog=CAPdb;Integrated Security=True;TrustServerCertificate=True;";
