...
namespace AMAY_QUEVEDO_ZAMORA_PROJECT
{
    ...
    {
        private readonly string connectionString = @"Data Source=LAPTOP-GPJQLLD4V\SQLEXPRESS1;Initial Catalog=CAPdb;User ID=CampusAnnouncementPortal;Password=campus123;Connect Timeout=30;TrustServerCertificate=True;";
