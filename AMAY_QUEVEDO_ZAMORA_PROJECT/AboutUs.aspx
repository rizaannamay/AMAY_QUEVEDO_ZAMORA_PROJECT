...
.gallery-copy h4 { color: var(--primary); margin-bottom: 8px; font-size: 1rem; }
...
.creator-photo { width: 120px; height: 120px; border-radius: 50%; overflow: hidden; border: 3px solid rgba(99,102,241,0.35); background: linear-gradient(135deg,rgba(99,102,241,0.25),rgba(59,130,246,0.2)); display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 24px rgba(0,0,0,0.25); transition: border-color 0.3s; }
body.dark-mode .creator-photo { border-color: rgba(147,197,253,0.3); box-shadow: 0 8px 24px rgba(0,0,0,0.4), 0 0 0 1px rgba(99,102,241,0.15); }
.creator-card:hover .creator-photo { border-color: rgba(99,102,241,0.6); }
.creator-photo img { width: 100%; height: 100%; object-fit: cover; display: block; }
.creator-photo i { font-size: 2.2rem; color: #ffffff; }
.creator-info h4 { color: var(--primary); font-size: 1.2rem; margin-bottom: 8px; }
...
body:not(.dark-mode) .image-modal-content { background: rgba(255,255,255,0.97); border-color: rgba(26,58,92,0.15); }
.image-modal-close { position: absolute; top: 14px; right: 14px; width: 42px; height: 42px; border: none; border-radius: 50%; background: rgba(99,102,241,0.15); border: 1px solid rgba(99,102,241,0.25); color: #ffffff; font-size: 1.1rem; cursor: pointer; transition: background 0.2s; }
.image-modal-close:hover { background: rgba(99,102,241,0.3); }
body:not(.dark-mode) .image-modal-close { background: rgba(0,0,0,0.08); border-color: rgba(0,0,0,0.1); color: #1a2a3a; }
.image-preview { width: 100%; max-height: 68vh; object-fit: contain; display: block; border-radius: 20px; background: rgba(255,255,255,0.03); }
.image-caption { padding-top: 16px; }
.image-caption h4 { color: #93c5fd; font-size: 1.15rem; margin-bottom: 8px; }
...
<div class="page-shell">
    ...
    <section class="hero">
        <div class="hero-copy">
            ...
            <p>Campus Connect is a centralized web-based announcement system for Cebu Technological University.
            It helps students stay informed through official updates, exam schedules, class suspensions,
            campus activities, and important school notices in a clean and accessible space.</p>
            <div class="hero-stats">
                <div class="stat"><strong>24/7</strong><span>Access to official school announcements</span></div>
                <div class="stat"><strong>1 Hub</strong><span>For events, schedules, and updates</span></div>
                <div class="stat"><strong>Fast</strong><span>Designed to help students respond quickly</span></div>
            </div>
        </div>
    ...
    <section class="section-card">
        ...
        <div class="gallery-grid">
            <article class="gallery-card"
                onclick="openImageModal('Students activities.jpg','Student Activities','Celebrating student life through meaningful activities, shared experiences, and campus program highlights.')">
                <img src="Students activities.jpg" alt="Campus event announcement" />
                <div class="gallery-copy"><h4>Student Activities</h4></div>
            </article>
            <article class="gallery-card"
                onclick="openImageModal('Academic Updates.jpg','Academic Updates','A space for exam schedules, department notices, and registrar reminders that keep students informed.')">
                <img src="Academic Updates.jpg" alt="Academic announcement board" />
                <div class="gallery-copy"><h4>Academic Updates</h4></div>
            </article>
            <article class="gallery-card"
                onclick="openImageModal('School Campus View.jpg','Campus Highlights','Showcasing the campus environment, learning spaces, and facilities that shape student identity.')">
                <img src="School Campus View.jpg" alt="School campus view" />
                <div class="gallery-copy"><h4>Campus Highlights</h4></div>
            </article>
            <article class="gallery-card"
                onclick="openImageModal('School Announcent Campaign.jpg','Official Campaigns','Featuring school campaigns, bulletin reminders, awareness drives, and official event promotions.')">
                <img src="School Announcent Campaign.jpg" alt="School announcement campaign" />
                <div class="gallery-copy"><h4>Official Campaigns</h4></div>
            </article>
        </div>
    </section>
    ...
    <section class="section-card creators-section">
        ...
        <p class="creators-intro">This portal was created with the goal of making campus announcements more organized, accessible,
