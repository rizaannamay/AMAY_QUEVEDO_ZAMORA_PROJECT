...
<body class="antialiased relative">
    ...
    let likeCounts = STORAGE.get('sd_likeCounts')  || {};   // { id: number }
    let pins       = STORAGE.get('campus_pins')    || {};   // { id: true/false } — SHARED with Teacher.aspx
    ...
    function saveState() {
        ...
        STORAGE.set('campus_pins', pins);   // shared key
    ...
    function togglePin(id) {
        pins[id] = !pins[id];
        saveState();
        // Dispatch storage event so other open tabs (Teacher.aspx) sync immediately
    ...
    function postComment(id) {
        ...
        // Update comment list in-place (no full re-render)
