...
<head runat="server">
    ...
    .search-box { 
        ...
        /* This ensures it stays in the middle/right area naturally */
    }
...
.search-box input { 
    ...
    outline: none;
    margin-left: 10px; /* Changed from 428px to 10px */
    width: 100%; 
    font-size: 14px; 
}
            ...
            <main>
                ...
                <div class="card">
                    <div class="composer-top">
                        ...
                        <asp:TextBox ID="txtPostMessage" runat="server" CssClass="asp-input" placeholder="What's on your mind, Admin?"></asp:TextBox>
                    </div>
                    <div class="tools-bar">
                        <div style="display:flex; gap:20px; color:var(--text-muted); font-size: 14px; font-weight: 600;">
                            <div style="cursor:pointer;"><i class="fas fa-image" style="color:#45bd62; margin-right:8px;"></i>Photos/Video</div>
                            <div style="cursor:pointer;"><i class="fas fa-calendar-alt" style="color:#f7b928; margin-right:8px;"></i>Event</div>
                            <div style="cursor:pointer;"><i class="fas fa-poll" style="color:#f35369; margin-right:8px;"></i>Poll</div>
                        </div>
                        <asp:Button ID="btnPost" runat="server" Text="Post" CssClass="pill active" OnClick="btnPost_Click" Style="border:none;" />
                    </div>
                </div>
